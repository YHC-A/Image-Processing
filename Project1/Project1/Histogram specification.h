...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// pictureBox1
			// 
			this->pictureBox1->Location = System::Drawing::Point(67, 31);
			...
			// pictureBox2
			// 
			this->pictureBox2->Location = System::Drawing::Point(457, 31);
			...
			// pictureBox3
			// 
			this->pictureBox3->Location = System::Drawing::Point(839, 31);
			this->pictureBox3->Name = L"pictureBox3";
			this->pictureBox3->Size = System::Drawing::Size(260, 260);
			...
			this->chart1->Size = System::Drawing::Size(368, 300);
			...
			this->chart2->Location = System::Drawing::Point(396, 308);
			...
			this->chart2->Size = System::Drawing::Size(368, 300);
			...
			this->chart3->Location = System::Drawing::Point(781, 308);
			...
			this->chart3->Size = System::Drawing::Size(368, 300);
			...
			this->toolStrip1->Size = System::Drawing::Size(1168, 25);
			...
			this->ClientSize = System::Drawing::Size(1168, 646);
...
#pragma endregion
	...
	private: System::Void toolStripButton1_Click(System::Object^ sender, System::EventArgs^ e)
	{
		...
		// new image https://blog.csdn.net/u012372584/article/details/18231617
		...
		for (int i = 0; i < 256; i++) {
			...
			float check;
			for (int j = 0; j < 256; j++) {
				check = abs(total_P1[i] - total_P2[j]);						
				if (check < min) {
					min = check;							
					//最接近的pixel值，i是input image 的pixel值，j是output image的pixel值				
					map[i] = j;				
				}
			}
		}
		// combination new image
